...
import 'package:grocery_store/services/firestore_service.dart';
  ...
  runApp(
    MultiProvider(
      providers: [
        ...
        StreamProvider(
          create: (_) => FirestoreService().getBanners(),
          initialData: null,
        )
      ],
      child: const MyApp(),
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: Padding(
          ...
          child: _screens[Provider.of<ChangeScreen>(context).currentIndex],
        ),
